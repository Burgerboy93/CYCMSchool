...
namespace CYCMSchool.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,InstrumentName,InstrumentFamily")] Instrument instrument)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,InstrumentName,InstrumentFamily")] Instrument instrument)
        {
            if (id != instrument.Id)
            {
                return NotFound();
